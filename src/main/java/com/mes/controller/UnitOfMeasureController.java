...
public class UnitOfMeasureController {
    ...
    private void setupPermissions() {
        boolean canAdd = authService.hasPermission("uom:manage");
        boolean canEdit = authService.hasPermission("uom:manage");
        boolean canDelete = authService.hasPermission("uom:manage");
